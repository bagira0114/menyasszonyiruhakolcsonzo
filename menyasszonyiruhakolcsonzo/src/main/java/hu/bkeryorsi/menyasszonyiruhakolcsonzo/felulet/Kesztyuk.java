...
public class Kesztyuk extends javax.swing.JPanel {
    ...
    private void kesztyuBetolt(List<Kesztyu> kesztyu) {
    ...
    private void initComponents() {
        ...
        allapotComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                allapotComboBoxActionPerformed(evt);
            }
        });

        kesztyu_szures_gomb.setText("Keres");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(43, 43, 43)
                .addComponent(allapotComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void allapotComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_allapotComboBoxActionPerformed


    }//GEN-LAST:event_allapotComboBoxActionPerformed
    ...
    private void kesztyu_szures_gombActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kesztyu_szures_gombActionPerformed
       int beirtId;
        ...
        SQL sql = new SQL();
        List<Kesztyu> kesztyu = sql.searchKesztyu(beirtId, allapot);
        kesztyuBetolt(kesztyu);   // String kivalasztottAllap = (String) allapotComboBox.getSelectedItem(); //ez majd később kell, kiszedni a választást
